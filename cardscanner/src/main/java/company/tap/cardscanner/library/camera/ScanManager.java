package company.tap.cardscanner.library.camera;
...
import company.tap.cardscanner.library.camera.widget.CameraPreviewLayout;
import company.tap.cardscanner.library.camera.widget.CardDetectionStateView;
import company.tap.cardscanner.library.camera.widget.OnWindowFocusChangedListener;
import company.tap.cardscanner.library.ndk.DisplayConfigurationImpl;
import company.tap.cardscanner.library.ndk.RecognitionConstants;
import company.tap.cardscanner.library.ndk.RecognitionCore;
import company.tap.cardscanner.library.ndk.RecognitionResult;
import company.tap.cardscanner.library.ndk.RecognitionStatusListener;
import company.tap.cardscanner.library.utils.Constants;

import static company.tap.cardscanner.library.ndk.RecognitionConstants.RECOGNIZER_MODE_DATE;
import static company.tap.cardscanner.library.ndk.RecognitionConstants.RECOGNIZER_MODE_GRAB_CARD_IMAGE;
import static company.tap.cardscanner.library.ndk.RecognitionConstants.RECOGNIZER_MODE_NAME;
import static company.tap.cardscanner.library.ndk.RecognitionConstants.RECOGNIZER_MODE_NUMBER;
