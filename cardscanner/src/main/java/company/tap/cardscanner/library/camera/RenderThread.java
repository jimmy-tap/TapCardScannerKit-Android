...
import company.tap.cardscanner.library.camera.gles.Drawable2d;
import company.tap.cardscanner.library.camera.gles.EglCore;
import company.tap.cardscanner.library.camera.gles.GlUtil;
import company.tap.cardscanner.library.camera.gles.Sprite2d;
import company.tap.cardscanner.library.camera.gles.Texture2dProgram;
import company.tap.cardscanner.library.camera.gles.WindowSurface;
